...
//     version 1.2.0
//     from Assets/Level/Data/Input/StationaryInputSystem.inputactions
//
...
namespace Support
{
    public partial class @StationaryInputSystem : IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @StationaryInputSystem()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""StationaryInputSystem"",
    ""maps"": [
        {
            ""name"": ""FPS"",
    ...
    ""controlSchemes"": []
        ...
        public struct FPSActions
        {
            ...
            public FPSActions(@StationaryInputSystem wrapper) { m_Wrapper = wrapper; }
